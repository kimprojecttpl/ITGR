...
// v1.4: once an item reaches one of these, Owner/Evidence are locked for
// `user` (ClickUp Task link is exempt — always editable) until reopened via
// "Request for Approval".
export const TERMINAL_STATES = ["Compliant", "Complied with Condition", "Not Compliant"];
