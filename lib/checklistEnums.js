...
// The FY2026 workbook's self-assessment answer for each item (schema.sql
// v1.7's `item_status.self_assessment`) — kept deliberately separate from
// `status`, which only advances through the User -> Reviewer -> Approver
// workflow. Labels match index.html's SELF_TH/SELF_EN exactly; this is the
// one place server-side code can read them from instead of re-typing them.
export const SELF_ASSESSMENT_MARKS = ["〇", "×", "-"];
export const SELF_ASSESSMENT_LABELS = {
  "〇": { th: "ดำเนินการแล้ว", en: "Implemented" },
  "×": { th: "ยังไม่ดำเนินการ", en: "Not implemented" },
  "-": { th: "ไม่เกี่ยวข้อง", en: "Not applicable" },
};
